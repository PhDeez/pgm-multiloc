export class config {
  public static googleMapsKey: string = 'AIzaSyBAGQVYKsxZyr76unpfQQmAuUIRUL7pv30';
  public static latitude: number = 22.357618;
  public static longitude: number = 113.980928;
